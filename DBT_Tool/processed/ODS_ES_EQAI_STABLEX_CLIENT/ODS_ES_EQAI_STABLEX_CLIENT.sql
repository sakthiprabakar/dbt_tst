...
unique_key='PK_ODS_ES_EQAI_STABLEX_CLIENT_ID',
...
select
*
from {{ source('STAGING', 'STG_ES_EQAI_STABLEX_CLIENT') }}
{% if is_incremental() %}
...
, CTE_final as (
select
{{ generate_surrogate_key(['NUM_CLIENT']) }} as PK_ODS_ES_EQAI_STABLEX_CLIENT_ID,
CURRENT_TIMESTAMP as SYS_CREATE_DTM,
CTE_ins_batch_id.ins_batch_id as SYS_EXEC_ID,
CURRENT_TIMESTAMP as SYS_LAST_UPDATE_DTM,
NUM_CLIENT as CUSTOMER_ID,
NOM_CLIENT as CUSTOMER_NAME,
NOM_LEGAL_CLIENT as CUSTOMER_LEGAL_NAME,
TYPE_COMPG as COMPANY_TYPE,
ADR_CLIENT_1 as CUSTOMER_ADDRESS_1,
ADR_CLIENT_2 as CUSTOMER_ADDRESS_2,
NOM_VILLE as CITY_NAME,
CODE_POSTAL_CLIENT as CUSTOMER_POSTAL_CODE,
STATUT_CLIENT as CUSTOMER_STATUS,
DATE_MODFC_STATUT as STATUS_MODIFICATION_DATE,
DATE_CREAT_CLIENT as CUSTOMER_CREATION_DATE,
...
COMNT_CLIENT as CUSTOMER_COMMENT,
...
CODE_REPRS_CLIENT as CUSTOMER_REPRESENTATIVE_CODE,
...
SOLDE_CLIENT as CUSTOMER_BALANCE,
TPS as GST,
TVQ as QST,
NUM_CLIENT_CIE as COMPANY_CUSTOMER_NUMBER,
